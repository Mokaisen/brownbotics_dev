...
import numpy as np
from .policy_controller import PolicyController_mod
from isaacsim.core.utils.types import ArticulationAction
import time

class BrownbotPolicy(PolicyController_mod):
    ...
    def __init__(
        ...
        self.load_policy(
            "/isaac-sim/workspaces/isaac_sim_scripts/brownbot_hackhaton/brownbot_hackhaton_python/data_extension/policy_scripted.pt",
            "/isaac-sim/workspaces/isaac_sim_scripts/brownbot_hackhaton/brownbot_hackhaton_python/data_extension/env.yaml"        
        )
        #self.load_policy(
    ...
    def _compute_observation(self, 
        ...
        #obs[31:37] = ori_6d  # object orientation in 6D representation 
        #obs[37:40] = sizes  # object sizes
        #obs[28:31] = [4.2191e-01, -2.0915e-01, 4.5190e-02]

        # Object target pose
        # TODO how to access the mdp.generated_commands
        # obs[31:38] = [0.5,0,0.4,0,0,0,0]
        #obs[40:47] = self.target_pose_np.tolist() +  [8.4452e-04,
    ...
    def forward(self, dt, cube_position: np.ndarray, contact_sensors: List, replay_obs=None,
                ori_6d: np.ndarray = None,
                sizes: np.ndarray = None,
                box_data: np.ndarray = None,
                ee_data: np.ndarray = None,):
        """
        ...
        if self._policy_counter % self._decimation == 0:
            ...
            obs = self._compute_observation(cube_position, ori_6d, sizes, box_data, ee_data)
