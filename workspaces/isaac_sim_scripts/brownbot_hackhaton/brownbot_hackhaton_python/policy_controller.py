...
class PolicyController_mod(BaseController):
    """
    ...
    def load_policy(self, policy_file_path, policy_env_path) -> None:
        ...
        self.policy_device = next(self.policy.parameters()).device # modification
    ...
    def _compute_action(self, obs: np.ndarray) -> np.ndarray:
        ...
        with torch.no_grad():
            ...
            obs_tensor = torch.from_numpy(obs).view(1, -1).float().to(self.policy_device)
