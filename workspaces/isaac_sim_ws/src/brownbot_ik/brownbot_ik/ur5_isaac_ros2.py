...
class UR5Isaac(Node):
    ...
    def __init__(self):
        ...
        #### new subscriber for trigger goal signal
        ...
        ### client for isaac sim service to know prim position
        self.cli_pos = self.create_client(GetPrimAttribute, 'get_prim_attribute')
        self.req_pos = GetPrimAttribute.Request()
